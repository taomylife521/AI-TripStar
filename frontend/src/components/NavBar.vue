    ...
    <div class="container">
      ...
      <div class="navbar-collapse landing-navbar-collapse" id="navbarToggler">
        <ul class="navbar-nav ml-auto landing-nav">
          ...
          <li class="nav-item">
            <button type="button" class="nav-link landing-nav-btn settings-btn" @click="openSettingsDialog">
